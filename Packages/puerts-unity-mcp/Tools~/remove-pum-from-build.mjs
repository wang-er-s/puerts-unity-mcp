#!/usr/bin/env node
import { getBoolArg, getExtensionPackageNames, getToolRoots, parseArgs, removePumFromBuild, resolveUnityProjectRoot } from "./pum-cli-lib.mjs";
...
removePumFromBuild(projectRoot, {
  ...
  extensionPackageNames: getExtensionPackageNames(projectRoot)
});
